...
// /// Top-level helper so both ChatNotifier and _MessageBubble can call it
// /// without crossing Dart library-privacy boundaries.
...
//       messages: [...state.messages, mine],
//       isSending: true,
//       clearReply: true, // clear reply banner immediately
//     );

//     try {
//       final payload = <String, dynamic>{'message': text.trim()};

//       // If replying, use reply payload format
//       if (replyingTo != null) {
//         payload['type'] = 'reply';
...
//   // ── Send attachment via REST ───────────────────────────────────────────────

//   /// Uploads the file as multipart/form-data to POST /api/chats/
//   /// and inserts an optimistic bubble immediately.
...
//     // Optimistic bubble with local file path so user sees it instantly
...
//       timestamp: DateTime.now(),
//       status: MessageStatus.sending,
//       attachmentUrl: file.path, // local path for preview
...
//   // ── Fetch attachment URL for a message ────────────────────────────────────

//   /// Returns the attachment URL for a message id, or null on error.
...
// // ─────────────────────────────────────────────────────────────────────────────
// // _AttachOption — icon button in the attachment picker sheet
// // ─────────────────────────────────────────────────────────────────────────────
...
// // ─────────────────────────────────────────────────────────────────────────────
// // _MessageBubble — with reply preview and attachment display
// // ─────────────────────────────────────────────────────────────────────────────
...
//   final String otherName;
//   final Future<bool> Function(String messageId, String deleteType) onDelete;
//   final void Function(ChatMessage msg) onReply; // ← new
...
//     final senderName = message.repliedToSenderName ?? 'Unknown';
