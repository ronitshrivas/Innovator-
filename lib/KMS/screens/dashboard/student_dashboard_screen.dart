...
final studentAttendanceStatsProvider = FutureProvider<StudentAttendanceStats>((
  ref,
) async {
              ...
              recordsAsync.when(
                ...
                data:
                    (records) => Column(
                      children:
                          records
                              .map((r) => _AttendanceLogTile(record: r))
                              .toList(),
                    ),
              ),
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ...
            AppStyle.primaryColor.withValues(alpha: 0.80),
          ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${stats.className}  ·  Roll No: ${stats.rollNo}',
                        style: TextStyle(
