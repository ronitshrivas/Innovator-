...
//   // Payment
//   String _selectedPaymentType = 'cod'; // 'cod' | 'khalti'

//   // State
//   bool _isProcessing = false;
//   String? _orderId;
//   bool _khaltiUrlLaunched = false;
...
//   // Shipping charge (0 for now, update if backend changes)
...
//   // Always 2 steps: 0 = Customer Info, 1 = Payment Method
...
//   // Detect app resume after Khalti browser payment
//   @override
//   void didChangeAppLifecycleState(AppLifecycleState state) {
//     if (state == AppLifecycleState.resumed && _khaltiUrlLaunched) {
//       _khaltiUrlLaunched = false;
//       _onKhaltiReturn();
//     }
//   }
...
//       } else {
//         // _showSnackBar('Unexpected response. Please try again.', Colors.red);
//       }
//     } catch (e) {}
//   }
...
//       await _openKhaltiUrl(khaltiResponse);
//     } catch (e) {}
//   }

//   Future<void> _openKhaltiUrl(KhaltiPaymentResponse khalti) async {
//     final uri = Uri.parse(khalti.paymentUrl);
//     if (await canLaunchUrl(uri)) {
//       _khaltiUrlLaunched = true;
//       await launchUrl(uri, mode: LaunchMode.externalApplication);
//     } else {
//       _showSnackBar('Could not open Khalti payment page.', Colors.red);
//     }
//   }

//   /// Called when the app resumes after the Khalti browser session
//   void _onKhaltiReturn() {
//     if (!mounted) return;
//     _showKhaltiReturnDialog();
//   }
...
//                   ),
//                   child: const Text(
//                     'Your payment is being verified. Your order will be confirmed once the payment is successful.',
//                     textAlign: TextAlign.center,
...
//           _PaymentOptionCard(
//             title: 'Khalti',
//             subtitle: 'Pay securely via Khalti digital wallet',
//             icon: Icons.account_balance_wallet_outlined,
//             iconColor: const Color(0xFF5C2D91), // Khalti purple
//             isSelected: !_isCOD,
...
//           // Info card depending on selection
//           AnimatedSwitcher(
...
//             '2. You will be redirected to Khalti\n'
//             '3. Complete payment of NPR ${_grandTotal.toStringAsFixed(2)}\n'
//             '4. Return to the app — your order will be confirmed',
//             style: const TextStyle(
//               fontSize: 13,
//               height: 1.7,
//               color: Color(0xFF5C2D91),
