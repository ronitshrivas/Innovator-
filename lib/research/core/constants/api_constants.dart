class ResearchApi {
  ...
  static   String paymentInitiate(int paperId) => '$baseUrl/payment/initiate/$paperId';
static String getLimitedPaper (int page, int limit)=> '$baseUrl/research?$page&$limit';
